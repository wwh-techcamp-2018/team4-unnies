...
insert into category(id, name, created_at) values (3,'메인반찬', now());
insert into category(id, name, created_at) values (4,'아이반찬', now());
insert into category(id, name, created_at) values (5,'정기식단', now());
insert into category(id, name, created_at) values (6,'간편식', now());
insert into category(id, name, created_at) values (7,'간식', now());

-- 모집 중 샘플 데이터1 , 추가 신청할 경우 모집 완료로 변경
insert into product(id, description, expire_date_time, is_bowl_needed, max_participant, name, price, share_date_time, title, category_id, owner_id, created_at) values(1, '석윤이가 만든 진리의 탕수육입니다. 정말 맛있어요!', '2018-08-24 17:22:20', true, 4, '진리의 탕수육', 7000, '2018-08-25 15:22:20', '존맛 탕수육 나눠먹어요~', 3, 1, now());
-- 기간만료 샘플 데이터1
insert into product(id, description, expire_date_time, is_bowl_needed, max_participant, name, price, share_date_time, title, category_id, owner_id, created_at) values(2, '혁진이가 만든 엄청난 된장찌개입니다. 드셔보시면 본가 된장 찌개 저리가라 입니다.', '2018-08-22 15:22:20', false, 3, '퍽 된장찌개', 2500, '2018-08-23 15:22:20', '된장찌개 드시고 ... 혁진이의 퍼..ㄱ도 드세요', 2, 2, now());
-- 모집완료 샘플 데이터1
insert into product(id, description, expire_date_time, is_bowl_needed, max_participant, name, price, share_date_time, title, category_id, owner_id, created_at) values(3, '민성이가 만든 바삭한 소리가 지구 반대편 아르헨티나까지 들린다는 천국의 수제 감자튀김입니다. 드시고 천국가시죠(?)', '2018-08-26 15:22:20', true, 2, '내꼬 감자튀김', 3000, '2018-08-27 15:22:20', '감튀는 1년 내내', 6, 3, now());
-- 모집 중 샘플 데이터2
insert into product(id, description, expire_date_time, is_bowl_needed, max_participant, name, price, share_date_time, title, category_id, owner_id, created_at) values(4, '성열이가 만든 별미 곱창 사장님이 레시피 배우려고 뛰어오신다는 환상의 곱창볶음입니다. 당신의 술자리는 이제부터 성열이의 곱창 외에는 없습니다.', '2018-08-26 15:22:20', false, 3, '야식은 곱창', 10000, '2018-08-27 15:22:20', '내 곱창 진리 곱창', 5, 4, now());
-- 기간만료 샘플 데이터2
insert into product(id, description, expire_date_time, is_bowl_needed, max_participant, name, price, share_date_time, title, category_id, owner_id, created_at) values(5, '지우가 만든 장맛보다 찐한 수제 초콜릿입니다. 손맛 좀 보시죠. 쿨럭쿨럭', '2018-08-23 14:22:20', true, 3, '찰리와 촥컬릿 공장', 0, '2018-08-24 15:22:20', '팀장은 홍T', 7, 5, now());
-- 모집완료 샘플 데이터2
